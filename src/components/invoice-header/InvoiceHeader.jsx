...
const InvoiceHeader = ({ invoices, filteredInvoices, filter, setFilter }) => {
    ...
    return (
        <div className="invoice-header-area">
            ...
            <div className="invoice-header-area-content">
                <h3>Invoices - {filter ? filter : "All"}</h3>
                <p>
                    {filter
            ...
            <div className="invoice-header-area-filter">
                <div
                    className="invoice-header-area-filter-title"
            ...
            <div className="invoice-header-area-new">
